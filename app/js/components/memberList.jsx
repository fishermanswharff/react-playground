...
export default class MemberList extends BaseComponent {
  constructor(props){
    ...
    this.bind('buildMemberLists','removeProject','removeMember','addMember','fetchData','handleDataSnapshot');
  }
  ...
  render(){
    return(<ul className='project-lists'>{ Object.keys(this.state.projects).map(this.buildMemberLists) }</ul>)
  }
}
